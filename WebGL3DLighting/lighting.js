function intensity(p, N, V, lightPositions, lightDirections, lightIntensities, ambientLight, surfaceEmission)
{
  var Ifinal = 0.0;
  var ka = 0.5;
  var kd = 0.5;
  ...
  for (var i=0; i<lightPositions.length; i++)
  {
    ...
    var dist = Math.sqrt( ((p[0]-lp[0])*(p[0]-lp[0])) + ((p[1]-lp[1])*(p[1]-lp[1])) + ((p[2]-lp[2])*(p[2]-lp[2])) );
